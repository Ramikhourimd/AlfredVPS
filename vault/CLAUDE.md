...
- obsidian/system
- ai-assistant
janitor_note: FM001 — not a vault record. This is the Claude Code instruction file
  (claude.ai/code config). Should not have type/created frontmatter. LINK001 — wikilinks
  are documentation examples, not actual record links. Exclude from vault scanning.
relationships:
- confidence: 0.7
  context: AI notes and project overview
  source: CLAUDE.md
  target: README.md
  type: related-to
- confidence: 0.65
  context: AI notes and onboarding
  source: CLAUDE.md
  target: Start Here.md
  type: related-to
- confidence: 0.6
  context: AI bootstrap depends on person anchor
  source: CLAUDE.md
  target: assumption/Person Record as Identity Anchor for System Bootstrap.md
  type: depends-on
- confidence: 0.6
  context: AI relies on wikilink graph assump
  source: CLAUDE.md
  target: assumption/Wikilink Graph Is Sufficient for All Record Relationships.md
  type: depends-on
- confidence: 0.8
  context: AI supports Alfred project dev
  source: CLAUDE.md
