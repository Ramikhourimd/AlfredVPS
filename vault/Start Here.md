...
description: Overview of the Alfred OS vault — what it is, how it works, and how to
  set it up
janitor_note: 'LINK001 — broken wikilinks: [[person/Your Name]] is a placeholder example,
  [[wikilinks]] is a conceptual reference, [[_docs/architecture]], [[_docs/base-views]],
  [[_docs/sessions]], [[_docs/inputs-and-conversations]], [[_docs/alfred-instructions]],
  [[_docs/relationships]] reference docs that may not exist yet. ORPHAN001 — guide
  note, no inbound links expected. All require human review.'
name: Start Here
relationships:
- confidence: 0.8
  context: Onboarding supports Alfred project
  source: Start Here.md
  target: project/Alfred Development.md
  type: supports
- confidence: 0.7
  context: Start note covers bootstrap assump
  source: Start Here.md
  target: assumption/Person Record as Identity Anchor for System Bootstrap.md
  type: related-to
- confidence: 0.7
  context: Start note covers graph assump
  source: Start Here.md
